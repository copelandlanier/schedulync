...
namespace Calendar_NEW
{
    ...
    public partial class FTP_PROGRESS : BackgroundWorker
    {
        public FTP_PROGRESS()
        {
            InitializeComponent();
        ...
        public FTP_PROGRESS(IContainer container)
        {
            container.Add(this);
            InitializeComponent();
        }
        ...
        private void FtpProgress_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            int ChunkSize = 4096, NumRetries = 0, MaxRetries = 5;
            long SentBytes = 0;
            ...
            Global_Access.dialog_ftpsettings.ThreadSafeInvoke(() =>
            {
                Global_Access.dialog_ftpsettings.label_WLConnectedStatusDF.Text = "Database Status: CONNECTED";
                Global_Access.dialog_ftpsettings.DBConnected_LEDDF.BackColor = System.Drawing.Color.Green;
                Global_Access.dialog_ftpsettings.label_WLConnectedStatusNEW.Text = "Database Status: CONNECTED";
                Global_Access.dialog_ftpsettings.DBConnected_LEDNEW.BackColor = System.Drawing.Color.Green;
                Global_Access.dialog_ftpsettings.FTPButton_Next.Enabled = true;
            });
        }
